export const metadata = {
  title: "Liked — Jewel India",
  description: "Designs you've liked.",
};
export default function LikesPage() {
  return (
    <div className="flex-1 w-full max-w-5xl mx-auto px-4 md:px-8 py-8">
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-rose-50 to-pink-100 flex items-center justify-center">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="https://res.cloudinary.com/dcs0vuzwg/image/upload/v1777351889/liked_logo_mnifye.svg"
            alt="Liked"
        ...
        <p className="text-[15px] text-[#6B7280] text-center max-w-xs">
          All the designs you&apos;ve loved will appear here. Coming soon.
        </p>
