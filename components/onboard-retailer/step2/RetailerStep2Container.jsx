...
import { RetailerBusinessForm } from "./RetailerBusinessForm";
import { RetailerBusinessLogoUpload } from "./RetailerBusinessLogoUpload";
import { RetailerStep2Footer } from "./RetailerStep2Footer";

export function RetailerStep2Container() {
  const {
