...
export function EntryForm() {
  ...
  return (
    <form style={{ marginTop: 0 }} onSubmit={handleContinue}>
      ...
      <button
        ...
        style={{
          width: "100%",
          height: "56px",
          background: loading || !identity.trim() ? "#BBBBBB" : "#7A7A7A",
          color: "#FFFFFF",
          borderRadius: "8px",
          border: "none",
          fontSize: "15px",
        ...
        onMouseEnter={(e) => { if (!loading && identity.trim()) e.currentTarget.style.background = "#5A5A5A"; }}
        onMouseLeave={(e) => { if (!loading && identity.trim()) e.currentTarget.style.background = "#7A7A7A"; }}
      >
