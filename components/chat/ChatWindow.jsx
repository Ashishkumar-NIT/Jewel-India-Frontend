...
export function ChatWindow({ conversation, currentUserType, onBackToList }) {
  ...
  if (!conversation) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-white text-center p-8 border-l border-gray-100">
        <svg className="w-10 h-10 text-gray-300 mb-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
        </svg>
        <h3 className="text-[16px] font-semibold text-[#111827] mb-2">Select a query to view details</h3>
        <p className="text-[13px] text-gray-400 max-w-[240px] leading-relaxed">
          Click on a query from the list to read and respond
        </p>
      </div>
    );
  }
