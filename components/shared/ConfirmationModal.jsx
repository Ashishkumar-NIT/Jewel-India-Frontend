    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-sm rounded-[24px] shadow-2xl relative z-10 overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="p-8 text-center">
          ...
          <div className="mx-auto flex items-center justify-center w-14 h-14 rounded-full bg-red-50 mb-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              onClick={onConfirm}
              className="w-full py-3.5 bg-red-600 text-white text-[15px] font-bold rounded-xl hover:bg-red-700 transition-all active:scale-[0.98] shadow-sm shadow-red-200"
            >
              {confirmText}
            </button>
            <button
