 ...
 *
 * NANOBANA is Chamak 1.0, the original. Its renderer accepts a single
 * reference image, so Design 2 reaches it only as text inside the prompt.
 * OPENAI is Chamak 2.0, which sends both designs as real reference images.
 */
